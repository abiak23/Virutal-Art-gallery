...
$query1=mysqli_query($con,"delete from art where artist_id='$id'");
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="artistdetails.php" class="active-menu"><i class="fa fa-qrcode"></i>Artist</a>
                    </li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" cellpadding="0" cellspacing="0" border="0">
									...
									while($row=mysqli_fetch_array($query))
									{
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo htmlentities($row['artist_fname']);?></td>
											 <td><?php echo htmlentities($row['artist_lname']);?></td>
											<td><?php echo htmlentities($row['artist_email']);?></td>
                                            <td><?php echo htmlentities($row['artist_contact']);?></td>
											<td><?php echo htmlentities($row['artist_medium']);?></td>
											<td><img src="../Artist/img/<?php echo htmlentities($row['artist_image']);?>" width="40" height="40"></td>
											<td><?php echo htmlentities($row['artist_portfolio']);?></td>
											<td><a href="artistdetails.php?id=<?php echo htmlentities($row['artist_id']);?>&&action=del" title="Delete" onClick="return confirm('Do you really want to delete this Artist ?')" style="color:red">
