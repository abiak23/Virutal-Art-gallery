                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" cellpadding="0" cellspacing="0" border="0">
									...
									while($row=mysqli_fetch_array($query))
									{
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo htmlentities($row['member_id']);?></td>
											<td><?php echo htmlentities($row['title']);?></td>
                                            <td><?php echo htmlentities($row['amount']);?></td>
											<td><?php echo htmlentities($row['order_date']);?></td>
											<td><a href="orderdetails.php?id=<?php echo htmlentities($row['order_id']);?>&&action=del" title="Delete" onClick="return confirm('Do you really want to delete this Artist ?')" style="color:red">
