        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="member.php" class="active-menu"><i class="fa fa-table"></i> Art Members</a>
                    </li>
					<li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" cellpadding="0" cellspacing="0" border="0">
									...
									while($row=mysqli_fetch_array($query))
									{
                                        ...
                                        <tr class="odd gradeX">
											...
											<td><a href="member.php?mid=<?php echo htmlentities($row['id']);?>&&action=del" title="Delete" onClick="return confirm('Do you really want to delete this member ?')"><button type="button" class="btn btn-danger">Delete</button></a>
