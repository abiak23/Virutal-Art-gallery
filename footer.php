					...
					<div class="col-md-4 mb-md-0 mb-4 d-flex">
						<div class="con con-2 w-100 py-5">
							<div class="con-info w-100 text-center">
								...
								<div class="text">
									<span>artgallery10@gmail.com</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-4 mb-md-0 mb-4 d-flex">
						<div class="con con-3 w-100 py-5">
							<div class="con-info w-100 text-center">
								...
								<div class="text">
									<span>203 Fake St. Mountain View, New Street, India</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-7">
						<div class="row">
							<div class="col-md-4 mb-md-0 mb-4">
								<h2 class="footer-heading">Art Gallery</h2>
								<ul class="list-unstyled">
		              <li><a href="#" class="d-block">About</a></li>
		              <li><a href="#" class="d-block">Contact</a></li>
		              <li><a href="#" class="d-block">Artist</a></li>
		              <li><a href="#" class="d-block">Artworks</a></li>
		            </ul>
							</div>
							<div class="col-md-4 mb-md-0 mb-4">
								<h2 class="footer-heading">Top Categories</h2>
								<ul class="list-unstyled">
		              <li><a href="#" class="d-block">Sculpture</a></li>
		              <li><a href="#" class="d-block">Photography</a></li>
		              <li><a href="#" class="d-block">Drawing</a></li>
		              <li><a href="#" class="d-block">Work on paper</a></li>
					  <li><a href="#" class="d-block">Other Media</a></li>
		            </ul>
							</div>
							<div class="col-md-4 mb-md-0 mb-4">
								<h2 class="footer-heading">Who are We?</h2>
								<ul class="list-unstyled">
		              <li><a href="#" class="d-block">About us</a></li>
		              <li><a href="#" class="d-block">Our Artist</a></li>
		              <li><a href="#" class="d-block">Contact</a></li>
